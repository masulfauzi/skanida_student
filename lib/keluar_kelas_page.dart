    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _teacherNames = {for (var teacher in data) teacher['id_guru'].toString(): teacher['nama']};
  ...
  Future<void> _submitRequest() async {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          'siswa_id': SessionManager.siswaId,
          'keperluan': _keperluan,
          'guru_pengampu': _selectedTeacher,
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final errorMessage = jsonResponse['message'] ?? 'Terjadi kesalahan saat mengajukan izin keluar kelas';
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Izin keluar kelas berhasil diajukan. Mohon tunggu konfirmasi dari guru.'),
        actions: [
          TextButton(
            onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Izin Keluar Kelas', style: TextStyle(color: Colors.white)),
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<int>(
                  value: _lessonToJoin,
                  items: _lessons
                      .where((lesson) => _lessonToLeave == null || lesson >= _lessonToLeave!)
                      .map((lesson) {
                    return DropdownMenuItem<int>(
                      value: lesson,
                      child: Text('Jam ke-$lesson'),
                  ...
                  onChanged: _lessonToLeave != null ? (value) {
                    setState(() {
                      _lessonToJoin = value;
                    });
                  } : null,
                  ...
                  decoration: InputDecoration(
                    ...
                    helperText: _lessonToLeave == null ? 'Pilih jam keluar kelas terlebih dahulu' : '',
                  ),
                ),
